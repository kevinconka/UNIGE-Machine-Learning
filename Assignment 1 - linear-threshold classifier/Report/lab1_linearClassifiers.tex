...
\title{Machine learning lab assignment 1\\Linear-threshold classifiers}
%
%
...
% The paper headers
\markboth{Machine learning lab assignment 1, October 2017}%
...
\begin{abstract}
%\boldmath
This lab report introduces the concept of linear classifier and its performance on different 2D binary problems. A manual design approach is taken in the sens that there is no algorithm used for determining the decision boundary. Instead, a graphical trial-and-error method is used. Further analysis for robustness against random noise are presented and discussed.
\end{abstract}
...
% APPENDICES!!!!!!!!!!!!!!!!!!!
\appendices
\section{Auxiliary visualization plots}
...
\begin{figure}[h]
	...
	\includegraphics[width=.36\textwidth]{trials_1}
	\caption{Dataset 1, number of errors per trial.}
	\label{trials_1}
\end{figure}
\begin{figure}[h]
	\centering
	\captionsetup{justification=centering}
	\includegraphics[width=.36\textwidth]{trials_2}
	\caption{Dataset 2, number of errors per trial.}
	\label{trials_2}
\end{figure}
\begin{figure}[h]
	\centering
	\captionsetup{justification=centering}
	\includegraphics[width=.36\textwidth]{trials_3}
	\caption{Modified iris dataset, numbers of error per trial.}
	\label{trials_3}
\end{figure}
\begin{figure}[h]
	\centering
	\captionsetup{justification=centering}
	\includegraphics[width=.36\textwidth]{boxplot_1}
	\caption{Dataset 1, error boxplot.}
	\label{boxplot_1}
\end{figure}
\begin{figure}[h]
	\centering
	\captionsetup{justification=centering}
	\includegraphics[width=.36\textwidth]{boxplot_2}
	\caption{Dataset 2, error boxplot.}
	\label{boxplot_2}
\end{figure}
\begin{figure}[h!]
	\centering
	\captionsetup{justification=centering}
	\includegraphics[width=.36\textwidth]{boxplot_3}
	\caption{Modified iris dataset, error boxplot.}
	\label{boxplot_3}
\end{figure}
